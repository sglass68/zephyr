...
#define DT_IO_PHANDLE_FROM_PINCTRL(io_comp, inst, i) \
	DT_NPCX_COMP_INST_PHANDLE_BY_IDX(io_comp, inst, pinctrl, i)
...
/**
 * @brief Length of npcx_alt structures in 'pinctrl' property of specific
...
#define DT_NPCX_IO_ALT_ITEMS_LEN(io_comp, inst) \
			DT_PROP_LEN(DT_NPCX_COMP_INST(io_comp, inst), pinctrl)
